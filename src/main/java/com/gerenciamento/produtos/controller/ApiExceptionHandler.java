...
import com.gerenciamento.produtos.enums.ProblemType;
import com.gerenciamento.produtos.exception.BussinesException;
import com.gerenciamento.produtos.exception.HandlerNotFoundException;
import com.gerenciamento.produtos.exception.ProblemApi;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleTokenRefreshException(TokenRefreshException exception, WebRequest webRequest) {
        HttpStatus status = HttpStatus.FORBIDDEN;
        ProblemType problemType = ProblemType.REFRESH_TOKEN_EXPIRADO;

        String message = exception.getMessage();

        ProblemApi problemApi = createProblemBuilder(status, problemType, message)
                .message(message)
                .message("Atualmente o refreshToken está expirado.")
                .build();
