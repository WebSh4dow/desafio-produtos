...
public interface AutentecacaoControllerOpenApi {
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "Token JWT atualizado com sucesso"),
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "Token JWT atualizado com sucesso", response = TokenRefreshResponse.class),
            @ApiResponse(code = 400, message = "Erro na requisição"),
            @ApiResponse(code = 500, message = "Erro interno no servidor")
    })
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "Logout realizado com sucesso"),
            @ApiResponse(code = 500, message = "Erro interno no servidor")
    })
